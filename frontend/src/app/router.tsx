...
const CandidatesListPage = lazy(() => import('@/features/candidates/pages/candidates-list-page'))
const RecruiterCandidateProfilePage = lazy(() => import('@/features/candidates/pages/candidate-profile-page'))
const CandidatePipelinePage = lazy(() => import('@/features/candidates/pages/candidate-pipeline-page'))
